...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("mt-auto flex flex-col gap-2 border-t border-white/10 bg-[#050d22]/80 p-4", className)}
      {...props}
    />
  );
}
